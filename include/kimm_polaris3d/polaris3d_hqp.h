...
namespace RobotController{
    class FrankaWrapper{
        ...
        private:
            ...
            std::shared_ptr<kimmhqp::trajectory::TrajectorySE3Cubic> trajEE_Cubic_;
            std::shared_ptr<kimmhqp::trajectory::TrajectorySE3Constant> trajEE_Constant_;
            std::shared_ptr<kimmhqp::trajectory::TrajectorySE3Timeopt> trajEE_Timeopt_;            

            kimmhqp::trajectory::TrajectorySample sampleEE_, samplePosture_;
